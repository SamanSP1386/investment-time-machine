  ...
  return (
    <div className={className}>
      <button
        ...
        onClick={toggle}
        className={cn('flex w-full cursor-pointer items-center gap-2 text-left select-none', summaryClassName)}
      >
        <ChevronRight
          aria-hidden
          className={cn(
            'h-3.5 w-3.5 shrink-0 text-ink-muted transition-transform duration-150 ease-out',
            open && 'rotate-90',
            chevronClassName
          )}
        />
